...
class RevenuesControllerTest < ActionController::TestCase
  ...
  test "should create revenue" do
    assert_difference('Revenue.count') do
      post :create, revenue: { amount: @revenue.amount, r_type: @revenue.r_type, source: @revenue.source, token: @revenue.token }
    end
  ...
  test "should update revenue" do
    patch :update, id: @revenue, revenue: { amount: @revenue.amount, r_type: @revenue.r_type, source: @revenue.source, token: @revenue.token }
    assert_redirected_to revenue_path(assigns(:revenue))
  end
